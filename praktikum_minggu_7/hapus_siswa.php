...
<style>
        ...
        <div class="card login-form">
            <form method="post" class="formAdd">
                ...
                <input value="1" name="X" type="hidden">
                <div class="d-grid gap-2">
                <button type="submit" class="btnSave">Hapus</button>
                </div>
            </form>
        </div>
    </div>
<!-- <div class="global-container">
    <div class="card login-form">
        <form method="post" class="formAdd">
            <div class="form-floating mb-3">
                <input type="text" class="form-control" id="floatingInput" placeholder="Masukkan NIS" ><br>
                <label>NIS</label>
            </div>
